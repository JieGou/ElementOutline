...
namespace ElementOutline
{
    ...
    /// </summary>
    internal class JtBoundingBox2dInt
    {
        /// <summary>
        ...
        public Point2dInt MidPoint
        {
            get
            {
                return new Point2dInt((int)(0.5 * (xmin + xmax)), (int)(0.5 * (ymin + ymax)));
            }
        }
        ...
        public Point2dInt[] Corners
        {
            get
            {
                return new Point2dInt[] { Min, new Point2dInt(xmax, ymin), Max, new Point2dInt(xmin, ymax) };
            }
        }
        ...
        public string SvgViewBox
        {
            get
            {
                ...
                return string.Format("{0} {1} {2} {3}", left, bottom, w, h);
            }
        }
    }
}