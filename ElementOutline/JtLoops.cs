...
namespace ElementOutline
{
    ...
    /// </summary>
    internal class JtLoops : List<JtLoop>
    {
        public JtLoops(int capacity) : base(capacity)
        {
        }
        ...
        {
            List<Point[]> loops = new List<Point[]>(Count);
        ...
        public string SvgPath
        {
            get
            {
                return string.Join(" ", this.Select<JtLoop, string>(a => a.SvgPath));
            }
        }
    }
}